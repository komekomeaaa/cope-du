    ...
    <div className="min-h-screen">
      ...
      <main id="main-content" className="pt-32 pb-24 px-4">
        <div className="max-w-4xl mx-auto bg-white border border-slate-200/60 rounded-2xl shadow-lg p-8 md:p-12">
          <h1 className="text-4xl font-light text-slate-900 mb-8 font-[family-name:var(--font-display)]">プライバシーポリシー</h1>
          <div className="space-y-6 text-slate-600 leading-relaxed">
            <p>
              株式会社コグミル（以下、「当社」）は、お客様の個人情報を適切に取り扱い、法令に基づいて安全に管理します。
            </p>
            <section>
              <h2 className="text-2xl text-slate-900 mb-2">1. 取得する情報</h2>
              <p>お問い合わせ時に、氏名・メールアドレス・会社名・ご相談内容などを取得する場合があります。</p>
            </section>
            <section>
              <h2 className="text-2xl text-slate-900 mb-2">2. 利用目的</h2>
              <p>お問い合わせ対応、サービス提供、品質向上、重要なお知らせの配信に利用します。</p>
            </section>
            <section>
              <h2 className="text-2xl text-slate-900 mb-2">3. 第三者提供</h2>
              <p>法令に基づく場合を除き、ご本人の同意なく第三者へ提供しません。</p>
            </section>
            <section>
              <h2 className="text-2xl text-slate-900 mb-2">4. お問い合わせ窓口</h2>
