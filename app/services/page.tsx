          ...
          <div ref={productsAnimation.ref} className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8">
              {saasProducts.map((product, index) => (
                <Card
                  key={product.id}
                  className={`group relative bg-white border-0 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden ${product.popular ? 'ring-2 ring-blue-600' : ''
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-12">
              {saasFeatures.map((feature, index) => (
                <div
                  key={index}
                  className={`text-center transition-all duration-700 ${saasAnimation.isVisible
                    ? 'opacity-100 translate-y-0'
                    : 'opacity-0 translate-y-10'
                    }`}
                  style={{
