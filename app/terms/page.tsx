    ...
    <div className="min-h-screen">
      ...
      <main id="main-content" className="pt-32 pb-24 px-4 bg-white/30">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm p-8 md:p-12">
          <h1 className="text-4xl font-light text-gray-900 mb-8">利用規約</h1>
          <div className="space-y-6 text-gray-700 leading-relaxed">
            <p>本サイトをご利用いただく際は、以下の条件に同意したものとみなします。</p>
            <section>
              <h2 className="text-2xl text-gray-900 mb-2">1. 禁止事項</h2>
              <p>法令違反、公序良俗に反する行為、当社または第三者に不利益を与える行為を禁止します。</p>
            </section>
            <section>
              <h2 className="text-2xl text-gray-900 mb-2">2. 免責事項</h2>
              <p>当社は、サイト情報の正確性維持に努めますが、完全性を保証するものではありません。</p>
            </section>
            <section>
              <h2 className="text-2xl text-gray-900 mb-2">3. 著作権</h2>
              <p>本サイトに掲載される文章・画像・ロゴなどの権利は、当社または正当な権利者に帰属します。</p>
            </section>
            <section>
              <h2 className="text-2xl text-gray-900 mb-2">4. 規約改定</h2>
